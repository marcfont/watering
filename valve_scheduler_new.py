...
START_TIME_MORNING = time(17, 56, 0)
START_TIME_NIGHT = time(18, 6, 0)
...
if __name__ == '__main__':
    ...
    background_scheduler.add_job(schedule_morning_run, 'cron', args=morning_run.isoformat(),
    ...
    background_scheduler.add_job(schedule_night_run, 'cron', args=str(night_run.isoformat),
                                 hour=night_run.hour, minute=night_run.minute,
